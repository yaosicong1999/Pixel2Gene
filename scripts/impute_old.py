...
def impute(
        ...
        epochs, batch_size, prefix, experiment,
    ...
    kwargs_list = [
            dict(
                ...
                batch_size=batch_size, epochs=epochs, lr=1e-7,
                prefix=f'{prefix}{experiment}states/{i:02d}/',
...
def main():
    ...
    impute(
        ...
        n_states=args.n_states, prefix=args.prefix, experiment = args.experiment,
