...
def main():
    ...
    infile_cnts = f'{prefix}test-cnts.tsv'
    infile_locs = f'{prefix}test-locs.tsv'
    infile_img = f'{prefix}test-he.jpg'
    ...
    # select genes
    predicted_gene_names = read_lines(infile_genes)
    true_gene_names = cnts.columns.tolist()
    gene_names = list(set(predicted_gene_names).intersection(set(true_gene_names)))
